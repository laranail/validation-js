...
- `@laranail/validation-js`, a zero-dependency TypeScript runner implementing 69 rules.
...
- A differential test: the PHP suite records Laravel's own verdicts over 438 rule-and-value
